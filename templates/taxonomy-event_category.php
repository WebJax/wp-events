<?php
/**
 * Template for displaying Event Category taxonomy pages
 * 
 * This file can be overridden by copying it to yourtheme/wp-events/taxonomy-event_category.php
 * 
 * @package WP Events
 * @version 1.0.0
 */
        ...
        <div class="wp-events-archive">
            ...
            <?php else : ?>
                <div class="no-events-found">
                    ...
                    <p><?php esc_html_e( 'Der er ingen events i denne kategori endnu.', 'wp-events' ); ?></p>
                </div>
            <?php endif; ?>
        </div>
    </div>
